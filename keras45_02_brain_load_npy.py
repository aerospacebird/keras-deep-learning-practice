...
x_train = xy_train[0][0]  # [0] → x_train
y_train = xy_train[0][1]  # [1] → y_train
x_test =  xy_test[0][0]    # [0] x_test
y_test =  xy_test[0][1]    # [1] y_test
...
# np.save(np_path + 'keras44_01_x_train.npy', arr=x_train[0][0])
# np.save(np_path + 'keras44_01_y_train.npy', arr=x_train[0][1])

# np.save(np_path + 'keras44_01_x_test.npy', arr=x_test[0][0])
# np.save(np_path + 'keras44_01_y_test.npy', arr=x_train[0][1])
