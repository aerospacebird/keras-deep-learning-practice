...
# CNN
conv1 = Conv2D(64, (3,3), name='conv1')(input1)                         # (26,26,64)
conv2 = Conv2D(32, (3,3), activation='relu', name='conv2')(conv1)      # (24,24,32)
drop1 = Dropout(0.2, name='drop1')(conv2)

conv3 = Conv2D(32, (2,2), activation='relu', name='conv3')(drop1)      # (23,23,32)
conv4 = Conv2D(16, (2,2), activation='relu', name='conv4')(conv3)      # (22,22,16)
drop2 = Dropout(0.2, name='drop2')(conv4)

conv5 = Conv2D(32, (2,2), activation='relu', name='conv5')(drop2)      # (21,21,32)
drop3 = Dropout(0.2, name='drop3')(conv5)

conv6 = Conv2D(16, (2,2), activation='relu', name='conv6')(drop3)      # (20,20,16)


# Flatten
flat1 = Flatten(name='flatten')(conv6)                                  # (6400,)


# Dense
dense1 = Dense(32, activation='relu', name='dense1')(flat1)
drop4 = Dropout(0.2, name='drop4')(dense1)
dense2 = Dense(16, activation='relu', name='dense2')(drop4)


# Output
output1 = Dense(10, activation='softmax', name='output1')(dense2)
