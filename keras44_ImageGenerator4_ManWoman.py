...
print(x_train.shape, y_train.shape) #(10, 100, 100, 3) (10,)
print(x_test.shape, y_test.shape)   #(10, 100, 100, 3) (10,)
#exit()
############################################    np.save( )                    ########################################
np_path = './_save/man_woman_cnn/'             #
np.save(np_path + 'keras44_03_x_train.npy' , arr = xy_train[0][0])  # arr = x_train 도가능 
np.save(np_path + 'keras44_03_y_train.npy' , arr = xy_train[0][1])  # arr = y_train 도가능
np.save(np_path + 'keras44_03_x_test.npy' , arr = xy_train[0][0])   # arr = x_test 도가능
np.save(np_path + 'keras44_03_y_test.npy' , arr = xy_train[0][1])   # arr = y_test 도가능
######################################################################################################################
