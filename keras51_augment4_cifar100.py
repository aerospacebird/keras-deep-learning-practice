...
augment_size = 40000  
#randidx = np.random.randint(x_train.shape[0], size=augment_size)  #choice를 사용하라. 중복이 있을 수 있다.
randidx = np.random.choice(x_train.shape[0], size=augment_size)  #choice를 사용하라.
