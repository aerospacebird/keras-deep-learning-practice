...
# Block 1
model.add(Conv2D(32, (5, 5), activation='relu',input_shape=(28, 28, 1)))  # (3,3)
...
#  conv2d_4 (Conv2D)           (None, 21, 21, 32)        4128      
