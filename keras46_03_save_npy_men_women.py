...
np.save(np_path + 'keras46_03_x_train.npy' , arr = xy_train[0][0])  # arr = x_train 도가능 
np.save(np_path + 'keras46_03_y_train.npy' , arr = xy_train[0][1])  # arr = y_train 도가능
np.save(np_path + 'keras46_03_x_test.npy' , arr = xy_train[0][0])   # arr = x_test 도가능
np.save(np_path + 'keras46_03_y_test.npy' , arr = xy_train[0][1])   # arr = y_test 도가능
######################################################################################################################
