...
dense2 = Dense(64, name='ys2')(dense1)
dense3 = Dense(128, name='ys3')(dense2)
dense4 = Dense(64, name='ys4')(dense3)
dense5 = Dense(32, name='ys5')(dense4)
dense6 = Dense(16, name='ys6')(dense5)
dense7 = Dense(8, name='ys7')(dense6)
...
model = load_model('./_save/keras32/keras32_mcp5.keras')
