...
# ============================================================
# 2. Model Construction - DNN Functional API
# ============================================================
...
# Dense 128
dense3 = Dense(128, activation='relu', name='dense3')(drop2)
bn3 = BatchNormalization(name='bn3')(dense3)
drop3 = Dropout(0.2, name='dropout3')(bn3)

# Dense 64
dense4 = Dense(64, activation='relu', name='dense4')(drop3)
bn4 = BatchNormalization(name='bn4')(dense4)
drop4 = Dropout(0.2, name='dropout4')(bn4)

# Dense 32
dense5 = Dense(32, activation='relu', name='dense5')(drop4)
bn5 = BatchNormalization(name='bn5')(dense5)
drop5 = Dropout(0.2, name='dropout5')(bn5)

# Dense 16
dense6 = Dense(16, activation='relu', name='dense6')(drop5)
bn6 = BatchNormalization(name='bn6')(dense6)

# Output : 100 classes
output1 = Dense(100, activation='softmax', name='output1')(bn6)
...
# 걸린시간 :  124.65 초
###########################################################################################################
# loss: 3.2888472080230713
# acc: 0.21690000593662262
# 313/313 [==============================] - 0s 1ms/step
# accuracy_score :  0.2169
# 걸린시간 :  407.4 초

# DNN = 일반적인 비선형 함수 학습에 강함
# CNN = 공간적/지역적 패턴을 가진 데이터 학습에 강함