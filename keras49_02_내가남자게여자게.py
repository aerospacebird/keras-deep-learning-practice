...
img = load_img(my_image_path, target_size=(100, 100), color_mode='rgb')
...
print("결과 →", "남자" if pred_label == 1 else "여자")

# 5) 이미지 확인남ㅈ
plt.imshow(img, cmap='gray')
plt.title(f"예측: {'남자' if pred_label == 1 else '여자'} ({pred_prob:.2%})")
plt.axis('off')
plt.show()

############################################ my photo 사용한 예측 결과 입니다.##################################
# ================================ model.evaluate ================================
# 1/1 [==============================] - 0s 176ms/step - loss: 0.4925 - accuracy: 0.9000
# loss : 0.4925
# acc  : 0.9
# accuracy_score : 0.9
##############################################################################################################
# Epoch 8/100
# 32/32 [==============================] - 14s 353ms/step - loss: 0.0700 - accuracy: 0
...
# accuracy_score : 0.8
################################################################################################################
================================ model.evaluate my-photo 예측================================
# 1/1 [==============================] - 0s 221ms/step - loss: 0.6211 - accuracy: 0.9000
# loss : 0.6211
# acc  : 0.9
# accuracy_score : 0.9
