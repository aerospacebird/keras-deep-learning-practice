...
#model.save(path + 'keras29_5_save_weights1.h5')
#model.save(path + 'keras29_5_save_weights1.h5')
...
model = load_model(path + 'keras29_5_save_weights2.h5')
...
model.load_weights(path + 'keras29_5_save_weights2.h5')   #  훈련이 끝난 상태로 저장하여, 성능이 어느정도 보장된 상태로 저장하였다.
